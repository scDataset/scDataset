...
import scdataset
from scdataset import scDataset, MultiIndexable
from scdataset.strategy import (
    SamplingStrategy,
    Streaming,
    BlockShuffling,
...
from scdataset import auto_config
...
class TestModuleDocstrings:
    ...
    def test_scdataset_module_docstrings(self):
        ...
        assert results.failed == 0, f"Doctest failures in scdataset module: {results.failed}"
    ...
    def test_strategy_module_docstrings(self):
        ...
        assert results.failed == 0, f"Doctest failures in strategy module: {results.failed}"
    ...
    def test_multiindexable_module_docstrings(self):
        ...
        assert results.failed == 0, f"Doctest failures in multiindexable module: {results.failed}"
    ...
    def test_auto_config_module_docstrings(self):
        ...
        assert results.failed == 0, f"Doctest failures in auto_config module: {results.failed}"
